...
bool RH56F1_canfd_Protocol::writeRegister(Device device, const std::string& reg_name, const std::vector<int>& values) {
...
std::pair<bool, std::vector<int>> RH56F1_canfd_Protocol::readRegister(
    Device device,
...
std::pair<bool, TouchDataResult> RH56F1_canfd_Protocol::readTouchData(
    Device device,
    RingBuffer& ringBuffer,
    int version) {
