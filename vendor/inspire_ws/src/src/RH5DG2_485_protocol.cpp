...
bool RH5DG2_485_Protocol::writeRegister(Device device, const std::string& reg_name, const std::vector<int>& values) {
    std::ostringstream oss;
    auto logger = getLogger();
...
std::pair<bool, std::vector<int>> RH5DG2_485_Protocol::readRegister(Device device, RingBuffer& ringBuffer, const std::string& reg_name, size_t length) {
    std::ostringstream oss;
    auto logger = getLogger();
...
std::pair<bool, TouchDataResult> RH5DG2_485_Protocol::readTouchData(Device device, RingBuffer& ringBuffer, int version) {
    std::ostringstream oss;
    auto logger = getLogger();
