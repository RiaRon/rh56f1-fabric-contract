...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument("root_link", default_value="openarm_right_link0"),
        DeclareLaunchArgument("tip_link", default_value="palm_ee"),
        DeclareLaunchArgument("joint_state_topic", default_value="/joint_states"),
        DeclareLaunchArgument(
            "target_pose_topic", default_value="/openarm/right_arm/eef_target"
        ),
        DeclareLaunchArgument(
            "trajectory_topic",
            default_value="/right_joint_trajectory_controller/joint_trajectory",
        ),
        DeclareLaunchArgument("trajectory_time_sec", default_value="0.2"),
        Node(
            package="openarm_eef_control",
            executable="right_arm_eef_controller",
            output="screen",
            parameters=[{
